...
with open(os.path.join(file_path,"a7_dicc.txt"), 'w') as f:
...
with open(os.path.join(file_path,"a7_posting.txt"), 'w') as f:
    f.write("Act7\nArchivo--Frecuencia\n")
...
with open(os.path.join(file_path,"a7_matricula.txt"), 'w') as f:
    f.write("Act 7\n")
